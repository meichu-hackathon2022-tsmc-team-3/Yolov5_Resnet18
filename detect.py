...
from utils.utils.datasets import LoadStreams, LoadImages
from utils.utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path
from utils.utils.plots import plot_one_box, color_list
from utils.utils.torch_utils import select_device, load_classifier, time_synchronized, TracedModel
...
if __name__ == '__main__':
    ...
    IMAGE_PATH = '../test_set/JPEGImages'
    DEVICE = 'cpu'
